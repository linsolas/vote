 ...
 * Bootstrap v3.3.7 ()
 * Copyright 2011-2016 
 * Licensed under the Copyright Société Générale 2015 - All rights reserved license
 */
...
(function($) {
  ...
  /**
   * The megaDropdown component is an enhanced version of [Bootstrap dropdown](http://getbootstrap.com/components/#dropdowns).
   *
   ...
   * ```
   *
   * @function external:"$.fn".megaDropdown
...
/**
 * The notification component is applied on a SG-Bootstrap alert.
 *
 * Initialize it like this:
 *
 * **JavaScript**
 ...
 * @param options.closable : boolean
 * @param options.transition : string
 * @param options.fadeOut : object : { enabled: true, delay: 3000 }
 * @param options.message : object : { html: false, text: 'This is a message.' }
 * @param options.onClose : function
 * @param options.onClosed : function
 * @function external:"$.fn".sgbNotifation
 */
...
(function ($) {
    var Notification = function (element, options) {
        ...
        this.options  = $.extend(true, {}, $.fn.sgbNotification.defaults, options);
    ...
    $.fn.sgbNotification = function (options) {
        return new Notification(this, options);
    };

    $.fn.sgbNotification.defaults = {
        type: 'success',
        closable: true,
        transition: 'fade',
        fadeOut: {
...
(function($) {
    ...
    SgbSlider.prototype = {
        ...
        mouseDown: function (event) {
            ...
            $(window).on('mouseup', self.mouseUp);
        },
        mouseUp: function () {
            $(document).unbind('mousemove');
            $(document).unbind('mouseup');
    ...
    /**
     * The slider component is applied on a SG-Bootstrap slider.
     *
     * Initialize it like this:
     *
     * **JavaScript**
     ...
     *
     * @param options: object
     * @param options.ticks: boolean - default: false
     * @param options.color : string - default:null => can be primary, primary-alt
     * @param options.range: boolean - default : false
     * @param options.disabled : boolean - default: false
     * @param options.min : number - default: 0
     * @param options.max : number - default: 100
     * @param options.value : number - default: 0 => start value if it isn't range
     * @param options.step : number - default: 1
     * @param options.values : [number] - default: [0-100] => start values if it's range
     * @param handle : apply method option in specific handle
     * @param value : set handle value
     * @function external:"$.fn".sgbSwitch
     */
...
(function($) {
  ...
  /**
   * The stickyHeader component is applied on a SG-Bootstrap header and provides the animated sticky effect when scrolling towards the bottom of a page.
   *
   * Initialize it like this:
   *
   * **JavaScript**
   ...
   * ```
   *
   * @function external:"$.fn".stickyHeader
   */
...
(function ($) {
    ...
    /**
     * The switch component is applied on a SG-Bootstrap switch.
     *
     * Initialize it like this:
     *
     * **JavaScript**
     ...
     *
     * @param options: object
     * @param options.type: string - default: 'default'
     * @param options.isChecked : boolean - default:false
     * @param options.textOn : string - default: 'On'
     * @param options.textOff : string - default: 'Off'
     * @param options.iconOn : string - default: 'fa fa-check'
     * @param options.iconOff : string - default: 'fa fa-close'
     * @param options.onChange : function(valueBoolean) - default: null
     * @function external:"$.fn".sgbSwitch
     */
...
if (window.hasOwnProperty('CKEDITOR')) {CKEDITOR.config.uiColor = '#ffffff';}